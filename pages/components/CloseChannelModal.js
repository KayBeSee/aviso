...
const CloseChannelModal = ({ setModalOpen }) => {
  return (
        ...
        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          ...
          <div className="mt-2">
            <p className="text-sm text-gray-500">
              Are you sure you want to close this channel? You will no longer be
              able to send funds through it and will have to pay an onchain fee.
            </p>
          </div>
        </div>
      </div>
